  ...
  return (
    <section ref={scope} className="section-pad border-t border-line bg-night-panel">
      <div
        ...
        data-reveal=""
      >
        <p className="font-body text-[0.6rem] font-medium uppercase tracking-eyebrow text-gold md:text-[0.72rem]">
          Travel for People Who Move Differently
        </p>
        <p className="text-[0.82rem] leading-[1.7] text-cream-soft md:text-[0.95rem] md:leading-[1.8]">
          SIX TRAVEL&trade; creates experiences for people who value time,
          quality, discovery, and meaningful connection.
        </p>
        <p className="text-[0.66rem] uppercase leading-[1.8] tracking-[0.1em] text-mist md:text-[0.78rem] md:leading-[1.9] md:tracking-[0.14em]">
      ...
      <div
        ...
        data-reveal=""
      >
        <h3 className="font-display text-[1.6rem] italic leading-[1.2] text-cream md:text-[2.4rem]">
          Selective by Design
        </h3>
        <p className="max-w-[68ch] text-[0.84rem] leading-[1.7] text-mist md:text-[1.05rem] md:leading-[1.8]">
          Fewer templates. Greater imagination. Closer attention. Every
          journey deserves its own character.
        </p>
        <a
          href="#plan"
          className="group mt-4 inline-flex items-center gap-3 border-b border-gold/40 pb-2 font-body text-[0.56rem] uppercase tracking-[0.24em] text-gold transition-colors duration-500 ease-smooth hover:border-gold-deep hover:text-gold-deep md:text-[0.62rem] md:tracking-[0.3em]"
        >
          Start Your Journey
